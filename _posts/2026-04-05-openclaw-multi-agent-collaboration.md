...
![OpenClaw Multi-Agent Architecture](https://docs.openclaw.ai/images/og-default.png)
...
![Binding Priority](https://img.shields.io/badge/Priority_Tiers-8-blue)
...
![sessions_spawn](https://img.shields.io/badge/Pattern-Parent→Child-orange)
...
![sessions_send](https://img.shields.io/badge/Pattern-Peer↔Peer-blue)
...
회장님이 텔레그램에서 "빅터스야 이거 해줘"라고 하면, 해당 메시지는 바인딩을 통해 빅터스에게 라우팅된다. "헥스야 조사해줘"는 헥스에게. 한 게이트웨이, 여러 뇌, 각자의 기억.
